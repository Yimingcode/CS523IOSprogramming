...
class classViewController: UIViewController {
    ...
    @IBOutlet weak var classScroll: UIScrollView!
    ...
    func layoutViews(){
       ...
       //titleLabel.bottom= scrollview.top
        constraints += [NSLayoutConstraint.init(item: titleLabel, attribute: .bottom, relatedBy: .equal, toItem: classScroll, attribute: .top, multiplier: 1.0, constant: 10.0)]
        
        //MARK: statisticScroll layout constraints
        classScroll.translatesAutoresizingMaskIntoConstraints = false
        //statisricScroll.leading = view.leading
        constraints += [NSLayoutConstraint.init(item: classScroll, attribute: .leading, relatedBy: .equal, toItem: view.safeAreaLayoutGuide, attribute: .leading, multiplier: 1.0, constant: 0.0)]
        //statisricScroll.trailing = view.trailing
        constraints += [NSLayoutConstraint.init(item: classScroll, attribute: .trailing, relatedBy: .equal, toItem: view.safeAreaLayoutGuide, attribute: .trailing, multiplier: 1.0, constant: 0.0)]
        //statisricScroll.bottom = firstButton.top
        constraints += [NSLayoutConstraint.init(item: classScroll, attribute: .bottom, relatedBy: .equal, toItem: firstButton, attribute: .top, multiplier: 1.0, constant: 10.0)]
